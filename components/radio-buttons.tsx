...
export const RadioButtons = ({
  ...
  return (
    <View
      style={[
        tailwind`flex w-full flex-row jusitfy-between py-4 gap-4`,
        containerStyle,
      ]}
    >
      {options.map((option) => {
        ...
        return (
          <Pressable
            ...
            style={[
              tailwind`flex flex-row items-center gap-3  pb-4`,
              itemStyle,
            ]}
          >
            <View
              style={tailwind`flex items-center justify-center border rounded-full bg-white w-6 h-6 ${
